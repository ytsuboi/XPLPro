...
public:
    ...
    int isPortIgnored(const char* portName);

    // stuff for components
    int getComponentCount(void);
    int getComponentInfo(int element, int* type, const char** name, const char** board, int* pinCount, int* linkCount);
    ...
    int getComponentLinkInfo(int componentIndex, int linkIndex, char* inName, const char** outData);
    int getComponentLinkInfo(int componentIndex, int linkIndex, char* inName, int* outData);
